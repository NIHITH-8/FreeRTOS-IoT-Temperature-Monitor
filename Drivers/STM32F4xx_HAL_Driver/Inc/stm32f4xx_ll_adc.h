...
#define ADC_REG_RANK_2_SQRX_BITOFFSET_POS  ( 5UL)   
#define ADC_REG_RANK_3_SQRX_BITOFFSET_POS  (10UL)   
#define ADC_REG_RANK_4_SQRX_BITOFFSET_POS  (15UL)   
#define ADC_REG_RANK_5_SQRX_BITOFFSET_POS  (20UL)   
#define ADC_REG_RANK_6_SQRX_BITOFFSET_POS  (25UL)   
#define ADC_REG_RANK_7_SQRX_BITOFFSET_POS  ( 0UL)   
#define ADC_REG_RANK_8_SQRX_BITOFFSET_POS  ( 5UL)   
#define ADC_REG_RANK_9_SQRX_BITOFFSET_POS  (10UL)   
#define ADC_REG_RANK_10_SQRX_BITOFFSET_POS (15UL)   
#define ADC_REG_RANK_11_SQRX_BITOFFSET_POS (20UL)   
#define ADC_REG_RANK_12_SQRX_BITOFFSET_POS (25UL)   
#define ADC_REG_RANK_13_SQRX_BITOFFSET_POS ( 0UL)   
#define ADC_REG_RANK_14_SQRX_BITOFFSET_POS ( 5UL)   
#define ADC_REG_RANK_15_SQRX_BITOFFSET_POS (10UL)   
#define ADC_REG_RANK_16_SQRX_BITOFFSET_POS (15UL)   
...
#define ADC_REG_TRIG_EXTSEL_BITOFFSET_POS  (24UL)   
#define ADC_REG_TRIG_EXTEN_BITOFFSET_POS   (28UL)   
...
#define ADC_INJ_TRIG_EXTSEL_BITOFFSET_POS  (16UL)   
#define ADC_INJ_TRIG_EXTEN_BITOFFSET_POS   (20UL)   
...
#define ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS ( 0UL)  
...
#define ADC_CHANNEL_ID_INTERNAL_CH_2       0x40000000UL     
...
#define ADC_CHANNEL_0_SMP                  (ADC_SMPR2_REGOFFSET | (( 0UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_1_SMP                  (ADC_SMPR2_REGOFFSET | (( 3UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_2_SMP                  (ADC_SMPR2_REGOFFSET | (( 6UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_3_SMP                  (ADC_SMPR2_REGOFFSET | (( 9UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_4_SMP                  (ADC_SMPR2_REGOFFSET | ((12UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_5_SMP                  (ADC_SMPR2_REGOFFSET | ((15UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_6_SMP                  (ADC_SMPR2_REGOFFSET | ((18UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_7_SMP                  (ADC_SMPR2_REGOFFSET | ((21UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_8_SMP                  (ADC_SMPR2_REGOFFSET | ((24UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_9_SMP                  (ADC_SMPR2_REGOFFSET | ((27UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_10_SMP                 (ADC_SMPR1_REGOFFSET | (( 0UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_11_SMP                 (ADC_SMPR1_REGOFFSET | (( 3UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_12_SMP                 (ADC_SMPR1_REGOFFSET | (( 6UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_13_SMP                 (ADC_SMPR1_REGOFFSET | (( 9UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_14_SMP                 (ADC_SMPR1_REGOFFSET | ((12UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_15_SMP                 (ADC_SMPR1_REGOFFSET | ((15UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_16_SMP                 (ADC_SMPR1_REGOFFSET | ((18UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_17_SMP                 (ADC_SMPR1_REGOFFSET | ((21UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
#define ADC_CHANNEL_18_SMP                 (ADC_SMPR1_REGOFFSET | ((24UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS))   
...
#define ADC_CR1_RES_BITOFFSET_POS          (24UL)   
#define ADC_TR_HT_BITOFFSET_POS            (16UL)   
